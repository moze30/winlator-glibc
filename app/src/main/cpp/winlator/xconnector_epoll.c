...
Java_com_winlator_glibc_xconnector_XConnectorEpoll_createAFUnixSocket(JNIEnv *env, jobject obj,
                                                                jstring path) {
...
JNIEXPORT jint JNICALL
Java_com_winlator_glibc_xconnector_XConnectorEpoll_createEpollFd(JNIEnv *env, jobject obj) {
    return epoll_create(MAX_EVENTS);
}

JNIEXPORT void JNICALL
Java_com_winlator_glibc_xconnector_XConnectorEpoll_closeFd(JNIEnv *env, jobject obj, jint fd) {
    close(fd);
}

JNIEXPORT jboolean JNICALL
Java_com_winlator_glibc_xconnector_XConnectorEpoll_doEpollIndefinitely(JNIEnv *env, jobject obj,
...
JNIEXPORT jboolean JNICALL
Java_com_winlator_glibc_xconnector_XConnectorEpoll_addFdToEpoll(JNIEnv *env, jobject obj,
                                                          jint epollFd,
                                                          jint fd) {
    struct epoll_event event;
    event.data.fd = fd;
...
JNIEXPORT void JNICALL
Java_com_winlator_glibc_xconnector_XConnectorEpoll_removeFdFromEpoll(JNIEnv *env, jobject obj,
                                                               jint epollFd, jint fd) {
    epoll_ctl(epollFd, EPOLL_CTL_DEL, fd, NULL);
}

JNIEXPORT jint JNICALL
Java_com_winlator_glibc_xconnector_ClientSocket_read(JNIEnv *env, jobject obj, jint fd, jobject data,
...
JNIEXPORT jint JNICALL
Java_com_winlator_glibc_xconnector_ClientSocket_write(JNIEnv *env, jobject obj, jint fd, jobject data,
                                                jint length) {
    char *dataAddr = (*env)->GetDirectBufferAddress(env, data);
...
JNIEXPORT jint JNICALL
Java_com_winlator_glibc_xconnector_XConnectorEpoll_createEventFd(JNIEnv *env, jobject obj) {
    return eventfd(0, EFD_NONBLOCK);
}

JNIEXPORT jint JNICALL
Java_com_winlator_glibc_xconnector_ClientSocket_recvAncillaryMsg(JNIEnv *env, jobject obj, jint clientFd, jobject data,
                                                           jint offset, jint length) {
    char *dataAddr = (*env)->GetDirectBufferAddress(env, data);
...
JNIEXPORT jint JNICALL
Java_com_winlator_glibc_xconnector_ClientSocket_sendAncillaryMsg(JNIEnv *env, jobject obj, jint clientFd,
...
JNIEXPORT jboolean JNICALL
Java_com_winlator_glibc_xconnector_XConnectorEpoll_waitForSocketRead(JNIEnv *env, jobject obj, jint clientFd, jint shutdownFd) {
