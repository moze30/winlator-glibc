...
Java_com_winlator_glibc_xserver_Drawable_drawBitmap(JNIEnv *env, jclass obj,
...
JNIEXPORT void JNICALL
Java_com_winlator_glibc_xserver_Drawable_copyArea(JNIEnv *env, jclass obj, jshort srcX,
...
JNIEXPORT void JNICALL
Java_com_winlator_glibc_xserver_Drawable_copyAreaOp(JNIEnv *env, jclass obj, jshort srcX,
                                              jshort srcY, jshort dstX, jshort dstY,
                                              jshort width, jshort height, jshort srcStride,
                                              jshort dstStride, jobject srcData,
...
JNIEXPORT void JNICALL
Java_com_winlator_glibc_xserver_Drawable_fillRect(JNIEnv *env, jclass obj, jshort x, jshort y,
...
JNIEXPORT void JNICALL
Java_com_winlator_glibc_xserver_Drawable_drawLine(JNIEnv *env, jclass obj, jshort x0, jshort y0,
...
JNIEXPORT void JNICALL
Java_com_winlator_glibc_xserver_Drawable_drawAlphaMaskedBitmap(JNIEnv *env, jclass obj,
...
JNIEXPORT void JNICALL
Java_com_winlator_glibc_xserver_Drawable_fromBitmap(JNIEnv *env, jclass obj, jobject bitmap,
                                              jobject data) {
...
JNIEXPORT void JNICALL
Java_com_winlator_glibc_xserver_Pixmap_toBitmap(JNIEnv *env, jclass obj, jobject colorData,
