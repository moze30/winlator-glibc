...
JNIEXPORT void JNICALL Java_com_winlator_glibc_XrActivity_init(JNIEnv *env, jobject obj) {
...
JNIEXPORT void JNICALL Java_com_winlator_glibc_XrActivity_bindFramebuffer(JNIEnv *env, jobject obj) {
    if (xr_initialized) {
        XrRendererBindFramebuffer(&xr_module_renderer);
    }
}

JNIEXPORT jint JNICALL Java_com_winlator_glibc_XrActivity_getWidth(JNIEnv *env, jobject obj) {
    int w, h;
    XrRendererGetResolution(&xr_module_engine, &xr_module_renderer, &w, &h);
    return w;
}
JNIEXPORT jint JNICALL Java_com_winlator_glibc_XrActivity_getHeight(JNIEnv *env, jobject obj) {
    int w, h;
    XrRendererGetResolution(&xr_module_engine, &xr_module_renderer, &w, &h);
    return h;
}

JNIEXPORT jboolean JNICALL Java_com_winlator_glibc_XrActivity_beginFrame(JNIEnv *env, jobject obj, jboolean immersive, jboolean sbs) {
...
JNIEXPORT void JNICALL Java_com_winlator_glibc_XrActivity_endFrame(JNIEnv *env, jobject obj) {
    XrRendererEndFrame(&xr_module_renderer);
    XrRendererFinishFrame(&xr_module_engine, &xr_module_renderer);
}

JNIEXPORT jfloatArray JNICALL Java_com_winlator_glibc_XrActivity_getAxes(JNIEnv *env, jobject obj) {
...
JNIEXPORT jbooleanArray JNICALL Java_com_winlator_glibc_XrActivity_getButtons(JNIEnv *env, jobject obj) {
